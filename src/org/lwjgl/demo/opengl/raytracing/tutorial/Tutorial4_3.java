...
public class Tutorial4_3 {
    ...
    private void createQuadProgram() throws IOException {
        ...
        int vshader = DemoUtils.createShader("org/lwjgl/demo/opengl/raytracing/tutorial4_3/quad.vs.glsl",
                GL_VERTEX_SHADER, "330");
        int fshader = DemoUtils.createShader("org/lwjgl/demo/opengl/raytracing/tutorial4_3/quad.fs.glsl",
    ...
    private void createComputeProgram() throws IOException {
         ...
         */
        int program = glCreateProgram();
        int random = DemoUtils.createShader("org/lwjgl/demo/opengl/raytracing/tutorial4_3/random.glsl",
                GL_COMPUTE_SHADER);
        int cshader = DemoUtils.createShader("org/lwjgl/demo/opengl/raytracing/tutorial4_3/raytracing.glsl",
                GL_COMPUTE_SHADER);
